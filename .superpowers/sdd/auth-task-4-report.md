...
- Definite-failure repair: focused browser suite passed 10/10. A terminal failed creation clears its opaque replay context, forces fresh discovery, and does not enable another create until the user supplies the exact confirmation again. Ambiguous action-required responses remain manual-review states.
