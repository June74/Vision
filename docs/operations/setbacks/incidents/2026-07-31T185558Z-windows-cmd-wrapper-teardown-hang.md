...
- **Last observed:** 2026-07-31T18:55:58.7433742Z
...
- **Hypotheses:** A real executable entrypoint or an explicit Windows
  process-tree termination strategy may preserve both safe argument handling
  and bounded settlement.
...
- **Owner:** Codex.
- **Next diagnostic step:** Inspect the provisional source/test diff and the
  existing terminate-and-await abstraction before choosing the next RED-GREEN
  step.
