...
- **Last observed:** 2026-08-12T18:58:53Z
...
`consumer_exit=1`, and `producer_closed_first=false`. This confirms the
matcher and supervisor mapping are functioning; the remaining failure is now
the underlying maintenance schedule contract, not an unrecognized stderr
dialect. No provider, deployment, credential, database, R2, Queue, or Worker
