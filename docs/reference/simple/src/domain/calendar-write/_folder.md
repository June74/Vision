...
provider-neutral before/after boundary used by one-off create. `mutation-
execution.ts` applies the shared freshness, claim, provider, read-back, audit,
and pending-state rules to those actions.
