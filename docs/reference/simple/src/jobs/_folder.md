...
and then applies retention. The temporary preview restore job admits one newest backup, forbids replacement, and
returns only independently verified count-and-boolean evidence.
